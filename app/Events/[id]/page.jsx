        ...
        <main className='text-[#073f3f]'>
            <div className='flex flex-col gap-10'>
                <div className='flex flex-col gap-10 items-center p-10 pb-5'>
                    ...
                    <h1 className=' text-4xl font-bold'>{perReviews.title} 's story</h1>
                    ...
                    <img src={perReviews.image} alt="logo" width={1000} height={1000} className="w-[95%]  lg:w-[70%] h-[77vh] lg:min-h-dvh rounded-sm" />
                ...
                <div className='flex flex-col items-center p-10 pb-5 gap-10'>
                   <img src={"https://i.pinimg.com/736x/8d/96/73/8d9673212f7b390c5488c7fce0d74fc3.jpg"} alt="logo" width={1000} height={1000} className="w-[95%]  lg:w-[70%] h-[77vh] lg:min-h-dvh rounded-sm" /> 
                   <img src={"https://i.pinimg.com/1200x/c9/31/76/c9317623662c6e652ea0330c7e48f590.jpg"} alt="logo" width={1000} height={1000} className="w-[95%]  lg:w-[70%] h-[77vh] lg:min-h-dvh rounded-sm" /> 
                   <img src={"https://i.pinimg.com/1200x/1c/cf/f1/1ccff1b70e691734e7c057a1be20ca5a.jpg"} alt="logo" width={1000} height={1000} className="w-[95%]  lg:w-[70%] h-[77vh] lg:min-h-dvh rounded-sm" /> 
                </div>
